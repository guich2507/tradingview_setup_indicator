...
Chaque condition est traitée **indépendamment**, puis agrégée pour le signal final.
...
Voir [PROJECT_GUIDE.md](PROJECT_GUIDE.md) pour le contexte et les objectifs du projet.
